<h1 align="center">
 <br>
  ...
  <br>
  Romel the Ultimate Discord Bot
  <br>
</h1>
...
## 🔗 [Invite the Public Bot (Romel) by clicking here!](<https://discord.com/oauth2/authorize?client_id=1368824214274048122&permissions=8&integration_type=0&scope=bot)

## About

Romel is a powerful, easy-to-use Discord bot designed to enhance your server experience with an extensive suite of features. Built with advanced security, automoderation, moderation, music systems, welcoming features, and more at its core, Romel ensures your community stays safe and well-managed, giving you peace of mind and control.
...
1. First, clone the repository:  
   ```bash
   git clone https://github.com/sonujana26/Romel-bot
   ```
...
1. Rename `example.env` to `.env` and replace the bot token value:
   ...
   ```
   • Replace the Owner ID(s) [here](https://github.com/sonujana26/Romel-bot/blob/main/utils/config.py#L7) (in `utils/config.py`).
2. **Prefix:**
   Default Prefix: `$`
   > You can change prefix **[here](https://github.com/sonujana26/Romel-bot/blob/main/utils/Tools.py#L84)**.
...
4. **For Music:**  
   ...
   > Update your Lavalink URL, password, and other configurations [by clicking here](https://github.com/sonujana26/Romel-bot/blob/main/cogs/commands/music.py#L339).
...
5. **Logging & Notifications:**  
   - **Command Logs:** Get a channel webhook URL and update it [here](https://github.com/sonujana26/Romel-bot/blob/main/main.py#L75) (in `main.py`).  
   - **Guild Joins:** Add the channel ID [here](https://github.com/sonujana26/Romel-bot/blob/main/cogs/events/on_guild.py#L25) (in `cogs/events/on_guild.py`).  
   - **Guild Leaves:** Add the channel ID [here](https://github.com/sonujana26/Romel-bot/blob/main/cogs/events/on_guild.py#L109) (in `cogs/events/on_guild.py`).
...
**Team:**
<div align="center">
  <a href="https://discord.gg/9jmCp9cnRc">
