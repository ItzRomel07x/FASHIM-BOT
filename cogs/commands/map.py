...
class MapView(ui.View):
    ...
    def get_coordinates(self, location):
        ...
        try:
            headers = {'User-Agent': 'Romel Bot (https://olyumpus.vercel.app)'}
    ...
    async def update_embed(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Made by Romel Development™")
        try:
    ...
    @discord.ui.button(label="", emoji="<:Romel_arrowLeft:1257731273938571305>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="",  emoji="<:Romel_arrowUp:1257731370814537831>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:Romel_bin:1254336650075701308>", style=ButtonStyle.danger)
    ...
    @discord.ui.button(label="", emoji="<:Romel_arrowDown:1257731390770909335>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:Romel_arrowRight:1257731310936391701>", style=ButtonStyle.secondary)
