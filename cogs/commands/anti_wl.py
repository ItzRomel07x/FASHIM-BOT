...
class Whitelist(commands.Cog):
    ...
    async def whitelist(self, ctx, member: discord.Member = None):
        ...
        if not member:
            ...
            embed.add_field(name="__**Usage**__", value=f"<:1476redsmalldot:1373016070042161182> `{prefix}whitelist @user/id`\n<:1476redsmalldot:1373016070042161182> `{prefix}wl @user`")
            embed.set_thumbnail(url=ctx.bot.user.avatar.url)
            return await ctx.send(embed=embed)
        ...
        embed = discord.Embed(
            ...
            color=0x000000,
            description=(
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Ban**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Kick**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Prune**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Bot Add**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Server Update**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Member Update**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Channel Create**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Channel Delete**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Channel Update**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Role Create**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Role Delete**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Role Update**\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Mention** @everyone\n"
                f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **Webhook Management**"
        ...
        embed.set_footer(text=f"Developed by Romel Development™")
        ...
        try:
            ...
            if interaction.data["custom_id"] == "catWl":
                ...
                embed = discord.Embed(
                    ...
                    color=0x000000,
                    description=(
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Ban**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Kick**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Prune**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Bot Add**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Server Update**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Member Update**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Channel Create**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Channel Delete**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Channel Update**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Role Create**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Role Delete**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Role Update**\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Mention** @everyone\n"
                        f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **Webhook Management**"
                ...
                embed_description = "\n".join(f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **{name}**" for key, name in fields.items())
                ...
                for value in interaction.data["values"]:
                    ...
                    embed_description = embed_description.replace(f"<:9279administrator:1373016157669425364><:5906modernstaff:1373016119253663876> : **{fields[value]}**", f"<:3365:1373021326691930202><:9279administrator:1373016157669425364> : **{fields[value]}**")
