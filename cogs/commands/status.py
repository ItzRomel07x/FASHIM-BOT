...
class Status(commands.Cog):
    ...
    async def status(self, ctx, user: discord.User = None):
        ...
        status_emoji = {
            "online": "<:romel_online:1228271960233082901> Online",
            "idle": "<:romel_idle:1228272291473784852> Idle",
            "dnd": "<:romel_dnd:1228272112368750613> Do Not Disturb",
            "offline": "<:romel_offline:1228272024829431873> Offline"
        }
        ...
        if member:
            status = status_emoji.get(str(member.status), "<:romel_offline:1228272024829431873> Offline")
            ...
            try:
                ...
                embed.add_field(name="Status:", value="<:romel_offline:1228272024829431873> Offline", inline=False)
