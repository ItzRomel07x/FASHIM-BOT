...
class AutoRole(commands.Cog):
    ...
    async def _ar_config(self, ctx):
        ...
        if data:
            ...
            emb.add_field(name="<:2382:1373021320895402085> __Humans__", value=hums, inline=False)
            emb.add_field(name="<:853:1373021304911040553> __Bots__", value=bos, inline=False)
