...
class HelpCommand(commands.HelpCommand):
  ...
  async def send_bot_help(self, mapping):
    ...
    embed = discord.Embed(description="<:5906modernstaff:1373016119253663876> **Loading Help module...**", color=color)
