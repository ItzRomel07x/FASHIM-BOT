...
class Voice(commands.Cog):
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        if member.voice is None:
            embed = discord.Embed(title="<:_cross:1227866668152393789> Error",
        ...
        embed2 = discord.Embed(title="<:_tick:1227866641027698792> Success",
    ...
    async def _mute(self, ctx, *, member: discord.Member = None):
        if member is None:
            embed = discord.Embed(
                title="<:_cross:1227866668152393789> Error",
        ...
        embed = discord.Embed(
            title="<:_tick:1227866641027698792> Success",
    ...
    async def vcunmute(self, ctx, *, member: discord.Member):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<:_cross:1227866668152393789> Error",
            ...
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention
        embed3 = discord.Embed(title="<:_tick:1227866641027698792> Success",
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<:_cross:1227866668152393789> Error",
...
@Author: Sonu Jana
    + Discord: me.sonu
    + Community: https://discord.gg/odx ( Development)
