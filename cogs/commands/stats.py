...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        processing_message = await ctx.send("<a:loading:1272527164256030873> Loading Romel information...")
        ...
        embed = Embed(title="Romel Statistics: General", color=0x000000)
    ...
    inline=False
        ...
        embed.set_footer(text="Powered by Romel Development™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def system_button_callback(interaction):
            if interaction.user == ctx.author:
                system_embed = Embed(title="Romel Statistics: System", color=0x000000)
                ...
                system_embed.set_footer(text="Powered by Romel Development™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def ping_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                ping_embed.set_footer(text="Powered by Romel Development™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def team_button_callback(interaction):
            if interaction.user == ctx.author:
                team_embed = Embed(title="Romel Team", color=0x000000)
                team_embed.add_field(name="**<:33379crownred:1379470104672211024> Bot Owner(s)**", value=">>> **[Sonu](https://discord.com/users/1070619070468214824)**,   **[!⌁𓆩ζ͜͡𝘿𝙉𝘼 𝙎𝙚𝙧𝙞𝙚𝙨ㄚㄒᥫ᭡](https://discord.com/users/677952614390038559)**,   **[Pritam](https://discord.com/users/1087282349395411015)**,   **[CuTeBoY.Ly](https://discord.com/users/995898882607292506)**", inline=False)
                team_embed.add_field(name="**<:Romel_developer:1250290657256538196> Bot Developer(s)**", value="> **[Sonu!?](https://discord.com/users/213347081799073793)** (Lead Developer)", inline=False)
                team_embed.add_field(name="**<:Romel_general:1222789674687397930> Web Developer(s)**", value="> **[Love](https://discord.com/users/773755998665441280)** (Lead Web Developer)", inline=False)
                team_embed.add_field(name="**<:Romel_utility:1222787342474154094> Tester(s)**", value="> **[! Lucifer](https://discord.com/users/1113040686686674987)**", inline=False)
                team_embed.add_field(name="**<:Romel_team:1243399230651895809> Team(s)**", value="> **[Romel Development™](https://discord.gg/odx)**", inline=False)
                team_embed.add_field(name="**<:Romel_partner:1228228301089144976> Partner(s)**", value="> **[Endercloud](https://endercloud.in/)**", inline=False)
                team_embed.set_footer(text="Powered by Romel Development™", icon_url=self.bot.user.display_avatar.url)
