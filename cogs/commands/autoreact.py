...
class AutoReaction(commands.Cog):
    ...
    async def add(self, ctx, trigger: str, *, emojis: str):
        if len(trigger.split()) > 1:
            embed = discord.Embed(
                title="<:xo_cross:1373021326691930202> Invalid Trigger",
        ...
        if len(emoji_list) > 10:
            embed = discord.Embed(
                title="<:xo_cross:1373021326691930202> Too Many Emojis",
        ...
        if len(triggers) >= 10:
            embed = discord.Embed(
                title="<:7942redmodshield:1373016146218848427> Trigger Limit Reached",
        ...
        if await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:7942redmodshield:1373016146218848427> Trigger Exists",
        ...
        embed = discord.Embed(
            title="<:3365:1373021326691930202> Trigger Added",
    ...
    async def remove(self, ctx, trigger: str):
        if not await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:xo_cross:1373021326691930202> Trigger Not Found",
        ...
        embed = discord.Embed(
            title="<:3365:1373021326691930202> Trigger Removed",
    ...
    async def reset(self, ctx):
        ...
        if not triggers:
            embed = discord.Embed(
                title="<:xo_cross:1373021326691930202> No Triggers Set",
        ...
        embed = discord.Embed(
            title="<:3365:1373021326691930202> All Triggers Reset",
