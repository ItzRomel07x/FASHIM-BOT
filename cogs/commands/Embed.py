    ...
    async def _embed(self, ctx):
        ...
        async def send_callback(interaction):
            ...
            try:
                ...
                await ctx.send(embed=discord.Embed(title="<:3365:1373021326691930202> Success",
        ...
        button_send = Button(label="Send Embed",  emoji="<:3365:1373021326691930202>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:xo_cross:1373021326691930202>", style=discord.ButtonStyle.danger)
