...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:Romel_users:1226064812157571163> Total Members: {total_members}\n<:2382:1373021320895402085> Total Humans: {total_humans}\n<:853:1373021304911040553> Total Bots: {total_bots}",
                        inline=False)

        embed.add_field(name="__Presence Stats:__", value=f"<:Romel_online:1228271960233082901> Online: {online}\n<:Romel_dnd:1228272112368750613> Dnd: {dnd}\n<:Romel_idle:1228272291473784852> Idle: {idle}\n<:Romel_offline:1228272024829431873> Offline: {offline}", inline=False)
  ...
  @commands.command(name="users", help="checks total users of Romel.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:Romel_users:1226064812157571163> Romel Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<a:Romel_WarnFlash:1272569018183843874> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="Romel Invite & Support!",
      description=
      f"> <:created:1272499720153202688> **[Romel - Invite Bot](<https://discord.com/oauth2/authorize?client_id=1368824214274048122&permissions=8&integration_type=0&scope=bot)**\n> <:created:1272499720153202688> **[Romel - Support](https://discord.gg/odx)**",
      color=0x000000)
    ...
    invite = Button(
      ...
      url=
      '<https://discord.com/oauth2/authorize?client_id=1368824214274048122&permissions=8&integration_type=0&scope=bot'
    )
