...
class OnOrOff(BasicView):
    ...
    @discord.ui.button(label="DM me", emoji="<:3365:1373021326691930202>", custom_id='Yes', style=discord.ButtonStyle.green)
    async def dare(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.value = 'Yes'
        await interaction.response.defer()
        self.stop()

    @discord.ui.button(label="Don't DM", emoji="<:xo_cross:1373021326691930202>", custom_id='No', style=discord.ButtonStyle.danger)
...
class afk(commands.Cog):
    ...
    async def afk(self, ctx, *, reason=None):
        ...
        if any(invite in reason.lower() for invite in ['discord.gg', 'gg/']):
            emd = discord.Embed(description="<:7762modernraid:1373016136467222699> | You can't advertise Serve Invite in the AFK reason", color=0x0c0606)
        ...
        async with aiosqlite.connect(DB_PATH) as db:
            ...
            await test.delete()
            af = discord.Embed(title='<:3365:1373021326691930202> Success', 
