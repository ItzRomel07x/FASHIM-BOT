        ...
        try:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                if guild_id:
                    ...
                    if channel:
                        embed = discord.Embed(
                            title="<a:Romel_WarnFlash:1272569018183843874> Guild Blacklisted",
                            description=(
                                f"This guild has been blacklisted due to spamming or automation. "
                                f"If you believe this is a mistake, please contact our [Support Server](https://discord.gg/9jmCp9cnRc) with any proof if possible."
                            ),
                            color=0x000000
                        )
            ...
            if len(self.guild_command_tracking[guild_id]) > 8:
                ...
                embed = discord.Embed(
                    ...
                    description=(
                        ...
                        f"If you believe this is a mistake, please contact our [Support Server](https://discord.gg/9jmCp9cnRc)."
                    ),
                    color=0x000000
                )
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                if message.content in (f'<@{self.bot_user_id}>', f'<@!{self.bot_user_id}>'):
                    ...
                    embed = discord.Embed(
                        title="<a:Romel_WarnFlash:1272569018183843874> User Blacklisted",
                        description=f"**{message.author.mention} has been blacklisted for repeatedly mentioning me. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/9jmCp9cnRc) with any proof if possible.**",
                        color=0x000000
                    )
                    await message.channel.send(embed=embed)
                    return
    ...
    async def on_command(self, ctx):
        ...
        if retry:
            async with aiosqlite.connect(self.db_path) as db:
                ...
                embed = discord.Embed(
                    title="<a:Romel_WarnFlash:1272569018183843874> User Blacklisted",
                    description=f"**{ctx.author.mention} has been blacklisted for spamming commands. If you believe this is a mistake, please contact our [Support Server](https://discord.gg/9jmCp9cnRc) with any proof if possible.**",
                    color=0x000000
                )
