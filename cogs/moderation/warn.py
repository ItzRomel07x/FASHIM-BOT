...
class Warn(commands.Cog):
    ...
    async def warn(self, ctx, user: discord.Member, *, reason=None):
        ...
        try:
            ...
            embed = discord.Embed(description=f"**<:RomelUser:1294654665895579721> Target User:** [{user}](https://discord.com/users/{user.id})\n"
                                              ...
                                              f"**<:RomelArrow:1297341001341599797> Reason:** {reason_to_send}\n"
                                              f"**<:RomelQuesMark:1297341037752221747> Total Warns:** {total_warns}",
                                              color=self.color)
    ...
    async def clearwarns(self, ctx, user: discord.Member):
        try:
            ...
            embed = discord.Embed(description=f"<:3365:1373021326691930202> | All warnings have been cleared for **{user}** in this guild.", color=self.color)
