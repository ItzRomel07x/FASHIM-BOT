...
class Lock(commands.Cog):
    ...
    async def lock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:RomelChannel:1297340969137471650> **Channel**: {channel.mention}\n<:RomelReason:1295595129809141812> **Status**: Locked\n<:RomelArrow:1297341001341599797> **Reason:** Lock request by {ctx.author}",
            color=self.color
        )
