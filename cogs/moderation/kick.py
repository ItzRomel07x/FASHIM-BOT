...
class Kick(commands.Cog):
    ...
    async def kick_command(self, ctx, member: discord.Member, *, reason: str = None):
        ...
        embed = discord.Embed(
            description=(
                f"**<:RomelUser:1294654665895579721> Target User:** [{member}](https://discord.com/users/{member.id})\n"
                f"<:RomelMention:1294654604998475856> **User Mention:** {member.mention}\n"
                f"<:Romel_reason:1295595129809141812> **Reason:** {reason}\n"
