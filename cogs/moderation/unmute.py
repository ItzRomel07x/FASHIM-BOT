...
class MuteReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<a:Romel_WarnFlash:1272569018183843874> You have been muted in **{interaction.guild.name}** for {time_str}. Reason: {reason}")
            dm_status = "Yes"
        except discord.Forbidden:
            dm_status = "No"
        ...
        success_embed = discord.Embed(
            description=f"**<:RomelUser:1294654665895579721> Target User:** [{self.user}](https://discord.com/users/{self.user.id})\n<:RomelMention:1294654604998475856> **User Mention:** {self.user.mention}\n**<:RomelReason:1295595129809141812> Reason:** {reason}\n<:RomelDM:1295595078122999915> **DM Sent:** {dm_status}", 
        ...
        success_embed.add_field(name="<:RomelMod:1295601558985379852> Moderator:", value=self.author.mention, inline=False)
...
class Unmute(commands.Cog):
    ...
    async def unmute(self, ctx, user: discord.Member):
        ...
        embed = discord.Embed(
            description=f"**<:RomelUser:1294654665895579721> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:RomelMention:1294654604998475856> User Mention:** {user.mention}\n<:RomelDM:1295595078122999915> **DM Sent:** {dm_status}",
            color=self.color
        )
