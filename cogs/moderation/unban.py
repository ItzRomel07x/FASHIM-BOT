...
class ReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<a:Romel_WarnFlash:1272569018183843874> You have been Banned from **{self.author.guild.name}** by **{self.author}**. Reason: {reason or 'No reason provided'}")
            dm_status = "Yes"
...
class Unban(commands.Cog):
    ...
    async def unban(self, ctx, user: discord.User, *, reason=None):
        ...
        embed = discord.Embed(description=f"**<:RomelUser:1294654665895579721> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:RomelMention:1294654604998475856> User Mention:** {user.mention}\n**<:RomelDM:1295595078122999915> DM Sent:** {dm_status}\n**<:RomelReason:1295595129809141812> Reason:** {reasonn}", color=self.color)
