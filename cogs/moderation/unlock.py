...
class LockUnlockView(ui.View):
    ...
    async def lock(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:RomelChannel:1297340969137471650> **Channel**: {self.channel.mention}\n<:RomelReason:1295595129809141812> **Status**: Locked\n<:RomelArrow:1297341001341599797> **Reason:** Lock request by {self.author}",
            color=0x000000
        )
...
class Unlock(commands.Cog):
    ...
    async def unlock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:RomelChannel:1297340969137471650> **Channel**: {channel.mention}\n<:RomelReason:1295595129809141812> **Status**: Unlocked\n<:RomelArrow:1297341001341599797> **Reason:** Unlock request by {ctx.author}",
            color=self.color
        )
