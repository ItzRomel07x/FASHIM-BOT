...
async def on_command_completion(context: commands.Context) -> None:
    ...
    webhook_url = "https://discord.com/api/webhooks/1369616714081501246/dTiu37yOXxEyGUyrefshOS705Xib4kyCguKnyzaxVAdCygI1q4MyItJQp_TT0vx9SZ8A"
    async with aiohttp.ClientSession() as session:
        ...
        if context.guild is not None:
            try:
                ...
                embed.set_footer(text="FAHIM Development™ ❤️",
            ...
            try:
                ...
                embed1.add_field(
                    ...
                    value=f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
                    inline=False)
                embed1.set_footer(text=f"Powered by FAHIM",
                                  icon_url=client.user.display_avatar.url)
