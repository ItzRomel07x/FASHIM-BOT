...
BOT_TOKEN = "MTM2ODgyNDIxNDI3NDA0ODEyMg.GUwWVI.gSy9IW9sNKqoXlc_YHPfUlGUtYVBEEWtCLhH08"
...
async def topgg():
    ...
    webhook_data = {
        ...
        "embeds": [
            {
                "description": "**[Voted Romel](https://top.gg/bot/1144179659735572640)**\n💖 Thank you for voting for Romel on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | Romel Development™ | {footer_time}",
